...
\usepackage[pdftex,
            pdftitle={Extensions to C++ Transactional Memory 2},
            pdfsubject={Extensions to C++ Transactional Memory 2},
...
%%--------------------------------------------------
%% macros specific to the Extensions to C++ Transactional Memory 2
