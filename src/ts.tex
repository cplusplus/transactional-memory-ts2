...
\usepackage{pdfpages}
\usepackage[pdftex,
            pdftitle={Programming Languages — Technical specification for C++ extensions for Transactional Memory 2},
            pdfsubject={C++ Transactional Memory Technical Specification 2},
            pdfcreator={Michael Wong, Jens Maurer, Hans Boehm, Michael Spear, Michael L.
Scott, and Victor Luchangco},
            bookmarks=true,
